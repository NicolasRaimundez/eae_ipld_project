...
min_temp = temps_df.loc[min_temp_index, "AvgTemperatureCelsius"] # TODO
max_temp = temps_df.loc[max_temp_index, "AvgTemperatureCelsius"] # TODO
...
# plt.title()   # TODO
# plt.xlabel()  # TODO
# plt.ylabel()  # # the libraries you have to use
import pandas as pd
import matplotlib.pyplot as plt
